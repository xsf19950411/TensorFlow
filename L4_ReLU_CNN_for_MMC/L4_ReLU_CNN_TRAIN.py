...
writer=tf.summary.FileWriter('F:/Files/Program/py/TensorFlow/L4_ReLU_CNN_for_MMC/summary', sess.graph)
...
f.close()
savePath=saver.save(sess, 'F:\Files\Program\py\TensorFlow\L4_ReLU_CNN_for_MMC\parameters.ckpt')
