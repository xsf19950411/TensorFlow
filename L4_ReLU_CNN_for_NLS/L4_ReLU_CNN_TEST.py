...
saver.restore(sess, 'F:\Files\Program\py\TensorFlow\L4_ReLU_CNN_for_NLS\parameters.ckpt')
...
x_singleTest[0, :]= np.sin(y_singleTest[0, :])

#############################文件操作##############################
with open('F:/Files/Program/py/TensorFlow/L4_ReLU_CNN_for_NLS/ori.txt', 'w') as f:
	f.write('')
with open('F:/Files/Program/py/TensorFlow/L4_ReLU_CNN_for_NLS/ori.txt', 'a') as f:
	y_reshape=np.reshape(y_singleTest, -1)
	for i in y_reshape:
		f.write(str(i))
		f.write('\n')
with open('F:/Files/Program/py/TensorFlow/L4_ReLU_CNN_for_NLS/detor.txt', 'w') as f:
	f.write('')
with open('F:/Files/Program/py/TensorFlow/L4_ReLU_CNN_for_NLS/detor.txt', 'a') as f:
	x_reshape=np.reshape(x_singleTest, -1)
	for i in x_reshape:
		f.write(str(i))
		f.write('\n')
with open('F:/Files/Program/py/TensorFlow/L4_ReLU_CNN_for_NLS/calc.txt', 'w') as f:
	f.write('')
with open('F:/Files/Program/py/TensorFlow/L4_ReLU_CNN_for_NLS/calc.txt', 'w') as f:
